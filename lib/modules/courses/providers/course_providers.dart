...
import 'package:my_college_progress/modules/courses/external/datasource/update_course_grades_datasource_impl.dart';
...
import 'package:my_college_progress/modules/courses/infra/repositories/update_course_grades_repository_impl.dart';
...
final updateCourseGradesProvider = UpdateCourseGradesImpl(
    UpdateCourseGradesRepositoryImpl(
        UpdateCourseGradesDatasourceImpl(AppDatabase())));
